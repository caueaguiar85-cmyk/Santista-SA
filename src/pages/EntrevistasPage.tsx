...
import { Plus, SlidersHorizontal, Notebook } from 'lucide-react';
...
const TAB_LIST = [
  { id: 'lista', label: 'Lista', icon: <Notebook size={15} /> },
  { id: 'nova',  label: 'Nova Entrevista', icon: <Plus size={15} /> },
];
    ...
    <div>
      ...
      {activeTab === 'nova' && (
        <div className="max-w-3xl">
          <InterviewForm onClose={handleFormClose} />
        </div>
      )}
    </div>
  );
